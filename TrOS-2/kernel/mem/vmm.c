...
// extern void paging_set_CR3(physical_addr_t addr);
...
// #endif
//
//     pde_set_pte(entry, (physical_addr_t)table_3_gb);
//
...
// #endif
//
//     pde_set_pte(entry2, (physical_addr_t)table_default);
//
...
//         paging_set_CR3((physical_addr_t)&dir->entries);
//         return 1;
//     }
// }
//
